...
const SearchBox = (props) => {
    ...
    return (
        <SearchBoxWrapper>
            ...
            <input type="text" className="box" placeholder="搜索歌曲、歌手、专辑" ref={queryRef} onChange={handleChange} />
            <i className="iconfont icon-delete" style={displayStyle} onClick={clearQuery} >&#xe600;</i>
        </SearchBoxWrapper>
    )
}
